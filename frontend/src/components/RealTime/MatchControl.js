...
const MatchControl = () => {
  ...
  const startMatch = async () => {
    try {
      const response = await fetch('http://46.226.166.162:5000/api/start_match', { method: 'POST' });
  ...
  const endMatch = async () => {
    try {
      const response = await fetch('http://46.226.166.162:5000/api/end_match', { method: 'POST' });
      const result = await response.json();
  ...
  const fetchMatchTime = async () => {
    try {
      const response = await fetch('http://46.226.166.162:5000/api/match_time');
      const result = await response.json();
  ...
  const clearTrajectoryPoints = async () => {
    try {
      const response = await fetch('http://46.226.166.162:5000/api/clear_trajectory_points', { method: 'POST' });
      const result = await response.json();
