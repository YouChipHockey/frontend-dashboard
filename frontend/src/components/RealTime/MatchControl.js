...
const MatchControl = () => {
  ...
  const startMatch = async () => {
    try {
      const response = await fetch('http://5.182.87.23:5000/api/start_match', { method: 'POST' });
  ...
  const endMatch = async () => {
    try {
      const response = await fetch('http://5.182.87.23:5000/api/end_match', { method: 'POST' });
      const result = await response.json();
  ...
  const fetchMatchTime = async () => {
    try {
      const response = await fetch('http://5.182.87.23:5000/api/match_time');
      const result = await response.json();
